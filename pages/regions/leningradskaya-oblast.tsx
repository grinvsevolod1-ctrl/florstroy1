    ...
    <>
      ...
      <RegionWrapper>
        <BasicSection imageUrl="/test-article/6.jpeg" title="Промышленные полы" overTitle="Ленинградская область">
          <p>
            FlorStroy работает по всей Ленинградской области: Гатчина, Выборг, Тосно, Кингисепп, Сертолово и другие города.
          </p>
          <StyledList>
            <li>Наливные полы для производственных помещений</li>
            <li>Бетонные основания с упрочнителем</li>
            <li>Полимерные покрытия для паркингов и площадок</li>
          </StyledList>
          <p>
            Работаем с гарантией, соблюдаем сроки, предоставляем фотоотчёты и техдокументацию.
          </p>
          <p>
