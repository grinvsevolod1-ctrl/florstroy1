...
const cards = [
  {
    ...
    description:
      'Покрытие применяется на открытых игровых спортивных и детских площадках, школьных стадионах, беговых дорожках. Устраивается по подготовленному бетонному, асфальтовому или грунтовому основанию.',
    priceWith: 'от 2200',
    priceWithout: 'от 1600',
    benefits: [
      'Однослойное покрытие с SBR или EPDM (толщина от 10 мм по твёрдому основанию, от 20 мм по грунту)',
      'Двухслойное покрытие с SBR и EPDM (финишный слой от 5 мм)',
      'Двухслойное покрытие с применением спрей-системы (средняя толщина 12 мм)',
    ],
  },
  {
    title: 'Промышленные бетонные полы',
    description:
      'Полы для производств и складов, устойчивые к ежедневным нагрузкам, весу техники и химическим веществам.',
    priceWith: 'от 1800',
    priceWithout: 'от 1300',
    benefits: [
      'Высокая механическая и химическая прочность',
      'Ровная нескользкая поверхность',
      'Долговечность и устойчивость к температуре',
      'Лёгкий и быстрый ремонт с сохранением внешнего вида',
      'Быстрый монтаж и доступная цена за м²',
    ],
  },
  {
    title: 'Полимерные наливные полы',
    description:
      'Самовыравнивающиеся полы для производственных, складских, торговых и офисных помещений. Устойчивы к влаге, химии и температурным перепадам.',
    priceWith: 'от 2000',
    priceWithout: 'от 1500',
    benefits: [
      'Бесшовность и герметичность',
      'Беспыльность и простота уборки',
      'Устойчивость к агрессивным средам',
      'Лёгкий ремонт и низкая стоимость обслуживания',
      'Ударостойкость, антистатичность и антипроводимость',
    ],
  },
];
